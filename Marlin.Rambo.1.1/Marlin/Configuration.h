...
#define STRING_CONFIG_H_AUTHOR "Anderson C Pilatti" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RAMBo Prusa i3 MK3"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 198.4230, 199.2944, 3098.6983, 203.39 }
